...
?>
    ...
    <body>
        ...
        <div class="film-container">
            ...
            $kullanıcıid = $_SESSION['Kullaniciid'];
            $Sorgu1 = mysqli_query($VeritabaniBaglantisi, "SELECT * FROM izlenme  WHERE kullanici_id = '$kullanıcıid'");
            if (mysqli_num_rows($Sorgu1) > 0) {
                ...
                echo "Henüz film izleme listenize eklemediniz";
            }
